package com.ficko.runnisticapp.adapters
...
class RunAdapter : RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    // Goes through old and new list and updates only those items that changed
    ...
    override fun onBindViewHolder(holder: RunViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            tvTime.text = TrackingUtility.getFormattedStopwatchTime(run.duration)
